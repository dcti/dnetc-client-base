...
extern "C" {
int crunch_vec_7450( RC5UnitWork *work, unsigned long iterations ); /* asm */
int crunch_allitnil( RC5UnitWork *, unsigned long iterations); /* asm */
s32 rc5_unit_func_vec_7450( RC5UnitWork *, u32 *timeslice, void *); /* this */
u32 rc5_unit_func_vec_7450_compat( RC5UnitWork *, u32 iterations ); /* this */
}
