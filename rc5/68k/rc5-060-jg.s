...
;--------------------
	...
	XDEF	_rc5_unit_func_060

	INCLUDE	rc5-0x0-jg.i

;--------------------
;@(#)$Id: rc5-060-jg.s,v 1.1.2.1 2000/06/05 15:21:21 oliver Exp $

	; $VER: MC68060 RC5 core 24-Jan-2000
	;
...
_rc5_unit_func_060:
	...
	RUF_ALIGN	_rc5_unit_func_060,d1	;Align to 8 bytes and pOEP
ruf060_mainloop:
	;A : d0 d4
	;L0: d1 d5
	;L1: d2 d6
