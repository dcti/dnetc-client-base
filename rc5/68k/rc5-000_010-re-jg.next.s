	...
	| $VER: MC68000/68010 reentrant RC5 core 04-Feb-2001

	|
	| MC680x0 RC5 key checking function
	| for distributed.net RC5-64 clients.
	|
	| Dual key, unrolled loops, MC68000/68010 optimised, rentrant
	|
	| Written by John Girvin <girv@girvnet.org.uk>
	|
	| TODO: for now this is almost identical to the 060 core
	|       some 000_010 optimisations are probably possible
	|
...
|--------------------
	...
	.reference	_rc5_check64

	.globl		_rc5_unit_func_000_010re

|--------------------

	|
	| MC680x0 RC5 key checking function
	| Dual key, unrolled loops, 000/010 optimised, rentrant
	|
	...
	|
	| NOTES:
	|   All cycle counts [n] are in 000/010 cycles.
	|

	.align 8
_rc5_unit_func_000_010re:
	movel	a7@(4),a0
	move.l	8(a7),d0
