...
return "@(#)$Id: selftest.cpp,v 1.47.2.48.4.3 2001/07/10 13:42:21 andreasb Exp $"; }
...
#if !defined(OGR_ALTERNATE_TESTCASES)
// nodecounts for OGROPT_ALTERNATE_CYCLE 0,1,2
...
#elif (OGR_ALTERNATE_TESTCASES == 3)
// nodecounts for OGROPT_ALTERNATE_CYCLE 3
static const s32 ogr_test_cases[TEST_CASE_COUNT][TEST_CASE_DATA] = {
  { 0x000D16F1, 21,  2, 22, 32, 21,  5,  1},
  {~0x0056B90C, 21,  1,  2,  4,  5,  8, 10},
  {~0x0058C007, 21,  2, 22, 32,  1,  3, 10},
  {~0x007C81BB, 22,  1,  2,  4,  5,  8, 10},
  { 0x00156F46, 22,  1,  8,  5, 29, 27, 36},
  {~0x001B6E27, 22,  1,  8,  5, 29, 27, 37},
  {~0x003E5256, 23,  1,  2,  4,  5,  8, 10},
  { 0x000EEF54, 23,  3,  4, 10, 44,  5, 25},
  {~0x00277F6B, 23,  3,  4, 10, 44,  5, 26},
  {~0x010F12FE, 24,  1,  2,  4,  5,  8, 10, 14},
  { 0x000A4FC5, 24,  9, 24,  4,  1, 59, 25},
  {~0x003895C1, 24,  9, 24,  4,  1, 59, 26},
  {~0x02E32CC0, 25,  1,  2,  4,  5,  8, 10, 14, 21},
  { 0x0018ED90, 25, 12, 17, 10, 33, 19, 55, 11},
  {~0x0120BA73, 25,  2,  7, 22,  5, 14,  4, 64, 37},
  { 0x000D16F1, 21,  2, 22, 32, 21,  5,  1},
  {~0x0056B90C, 21,  1,  2,  4,  5,  8, 10},
  {~0x0058C007, 21,  2, 22, 32,  1,  3, 10},
  {~0x007C81BB, 22,  1,  2,  4,  5,  8, 10},
...
#else
  #error What OGR testcases did you want ?
#endif
