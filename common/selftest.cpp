            ...
            switch (contest)
            {
              ...
              case OGR_NG:
              {
                if (expectedsolution_lo & 0x80000000)  // no solution
                {
                  ...
                  else if (resultcode != RESULT_NOTHING ||
