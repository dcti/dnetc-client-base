...
return "@(#)$Id: core_r72.cpp,v 1.62 2012/04/29 14:30:34 snikkel Exp $"; }
  ...
  // ===============================================================
    ...
    if (detected_type > 0)
    {
      switch ( detected_type & 0xffff) // only compare the low PVR bits
      {
        ...
        case 0x1302: cindex = 1; break; // 460EX/GT       == KKS 2pipes
...
//        case 0x0B: cindex = 6; break; // Most Pentium 4 == GO 2-pipe (#3960, #3265)
          ...
          case 0x20: cindex =11; break; // AMD APU        == GO 2-pipe-b (#4485)
