...
#define OGR_NG_GET_DISPATCH_TABLE_FXN  ogrng_get_dispatch_table_cj1_sse2
...
extern "C" int CDECL ogr_cycle_256_cj1_sse2(struct OgrState *oState, int *pnodes, const u16* pchoose);
...
static int ogr_cycle_256(struct OgrState *oState, int *pnodes, const u16* pchoose)
{
    ...
    return ogr_cycle_256_cj1_sse2(oState, pnodes, pchoose);
}
