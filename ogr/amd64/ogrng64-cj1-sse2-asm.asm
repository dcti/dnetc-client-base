;
; Assembly core for OGR-NG, 64bit SSE2 asm version. Based on generic 64 bit assembly core (ogrng64-cj1-generic-asm.asm) and SSE2 core (ogrng-cj1-sse2-asm.asm).
; $Id: ogrng64-cj1-sse2-asm.asm,v 1.1 2009/08/08 18:26:19 snikkel Exp $
;
...
%endmacro
	...
	global	_ogrng64_cycle_256_cj1_sse2, ogrng64_cycle_256_cj1_sse2
...
start:
	...
	; After Benchmarking I found 13 layers to be best, it probably varies depending on machine
	; The only reason I can think of why using multiples is better than one is branch prediction
	func	1, 2, 1
	func	2, 3, 1
	func	3, 4, 2
	func	4, 5, 3
