...
const char *ogr_arm2_cpp(void) {
return "@(#)$Id: ogr-arm2.cpp,v 1.1.2.1 2008/02/12 15:43:22 teichp Exp $"; }
  ...
  #define OGR_GET_DISPATCH_TABLE_FXN ogr_get_dispatch_table_arm2
