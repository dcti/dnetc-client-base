...
;
; Revision 1.4  1998/06/15 04:08:46  jlawson
; cs ds es ss assumed flat
;
...
ifndef __SMALL__ 
  .model flat 
        ...
        PUBLIC          _bryd_des               ; Located at 1:0004h Type = 1
        PUBLIC          _desinit                ; Located at 1:2BE8h Type = 1
        PUBLIC          _desencrypt             ; Located at 1:2D25h Type = 1
        PUBLIC          _desdecrypt             ; Located at 1:2EA1h Type = 1
        PUBLIC          _key_byte_to_hex        ; Located at 1:301Ah Type = 1
        PUBLIC          _c_key_byte_to_hex      ; Located at 1:3026h Type = 1
