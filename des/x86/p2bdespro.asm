; p2BDESPRO.ASM    Pentium Pro

; $Log: p2bdespro.asm,v $
; Revision 1.2  2002/09/02 00:35:45  andreasb
; sync: merged changes from release-2-7111 branch between
;       2000-07-11 and release-2-7111_20020901 into trunk
;
; Revision 1.1.2.1  2001/01/21 16:57:17  cyp
; reorg
;
; Revision 1.4  1998/12/25 03:23:44  cyp
...
;
; Revision 1.3  1998/06/18 05:46:57  remi
; Added $Id: p2bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and $Log: p2bdespro.asm,v $
; Added $Id$. and Revision 1.2  2002/09/02 00:35:45  andreasb
; Added $Id$. and sync: merged changes from release-2-7111 branch between
; Added $Id$. and       2000-07-11 and release-2-7111_20020901 into trunk
; Added $Id$. and
; Added $Id: p2bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and Revision 1.1.2.1  2001/01/21 16:57:17  cyp
; Added $Id: p2bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and reorg
; Added $Id: p2bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and
; Added $Id: p2bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and Revision 1.4  1998/12/25 03:23:44  cyp
; Added $Id: p2bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and Bryd now supports upto 4 processors. The third and fourth processor will
; Added $Id: p2bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and use the two (otherwise idle) cores, ie pro on a p5 machine and vice versa.
; Added $Id: p2bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and For non-mt builds the second cores (bbryd_des and bbryd_des_pro) are
; Added $Id: p2bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and aliased to the first two cores (bryd_des and bryd_des_pro) which should
; Added $Id: p2bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and make #ifdef checks around p2des_unit_func_[p5|pro]() obsolete.
; Added $Id: p2bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and.
;
...
; TASM Parity? seems buggy, so Parity? not used.
	...
	.data
_id	byte "@(#)$Id: p2bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $"
	byte 0
align 4
...
extern                  bbryd_continue_pro   :near
extern                  bbryd_key_found_pro  :near

public                  p2bryd_des
;public                  p2desencrypt
;public                  p2desdecrypt
;public                  p2desinit
;public                  p2key_byte_to_hex
;public                  p2c_key_byte_to_hex
