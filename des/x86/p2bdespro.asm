...
; Added $Id: p2bdespro.asm,v 1.1.2.1 2001/01/21 16:57:17 cyp Exp $. and $Log: p2bdespro.asm,v $
; Added $Id: p2bdespro.asm,v 1.4 1998/12/25 03:23:44 cyp Exp $. and Revision 1.1.2.1  2001/01/21 16:57:17  cyp
; Added $Id: p2bdespro.asm,v 1.4 1998/12/25 03:23:44 cyp Exp $. and reorg
; Added $Id: p2bdespro.asm,v 1.4 1998/12/25 03:23:44 cyp Exp $. and
; Added $Id: p2bdespro.asm,v 1.1.2.1 2001/01/21 16:57:17 cyp Exp $. and Revision 1.4  1998/12/25 03:23:44  cyp
; Added $Id: p2bdespro.asm,v 1.1.2.1 2001/01/21 16:57:17 cyp Exp $. and Bryd now supports upto 4 processors. The third and fourth processor will
; Added $Id: p2bdespro.asm,v 1.1.2.1 2001/01/21 16:57:17 cyp Exp $. and use the two (otherwise idle) cores, ie pro on a p5 machine and vice versa.
; Added $Id: p2bdespro.asm,v 1.1.2.1 2001/01/21 16:57:17 cyp Exp $. and For non-mt builds the second cores (bbryd_des and bbryd_des_pro) are
; Added $Id: p2bdespro.asm,v 1.1.2.1 2001/01/21 16:57:17 cyp Exp $. and aliased to the first two cores (bryd_des and bryd_des_pro) which should
; Added $Id: p2bdespro.asm,v 1.1.2.1 2001/01/21 16:57:17 cyp Exp $. and make #ifdef checks around p2des_unit_func_[p5|pro]() obsolete.
; Added $Id: p2bdespro.asm,v 1.1.2.1 2001/01/21 16:57:17 cyp Exp $. and.
;
...
; TASM Parity? seems buggy, so Parity? not used.
	...
	.data
_id	byte "@(#)$Id: p2bdespro.asm,v 1.1.2.1 2001/01/21 16:57:17 cyp Exp $"
	byte 0
align 4
