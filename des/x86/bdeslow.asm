...
; Added $Id: bdeslow.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and $Log: bdeslow.asm,v $
...
; Added $Id$. and
; Added $Id: bdeslow.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and Revision 1.1.2.1  2001/01/21 16:57:15  cyp
; Added $Id: bdeslow.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and reorg
; Added $Id: bdeslow.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and.
;
...
; TASM Parity? seems buggy, so Parity? not used.
	...
	.data
_id	byte "@(#)$Id: bdeslow.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $"
	byte 0
align 4
