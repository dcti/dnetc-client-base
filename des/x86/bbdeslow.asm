...
; $Log: bbdeslow.asm,v $
; Revision 1.2  2002/09/02 00:35:44  andreasb
...
; Added $Id: bbdeslow.asm,v 1.2 2002/09/02 00:35:44 andreasb Exp $. and $Log: bbdeslow.asm,v $
; Added $Id$. and Revision 1.2  2002/09/02 00:35:44  andreasb
...
; Added $Id$. and
; Added $Id: bbdeslow.asm,v 1.2 2002/09/02 00:35:44 andreasb Exp $. and Revision 1.1.2.1  2001/01/21 16:57:14  cyp
; Added $Id: bbdeslow.asm,v 1.2 2002/09/02 00:35:44 andreasb Exp $. and reorg
; Added $Id: bbdeslow.asm,v 1.2 2002/09/02 00:35:44 andreasb Exp $. and.
;
...
; TASM Parity? seems buggy, so Parity? not used.
	...
	.data
_id	byte "@(#)$Id: bbdeslow.asm,v 1.2 2002/09/02 00:35:44 andreasb Exp $"
	byte 0
align 4
