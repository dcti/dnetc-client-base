...
; Added $Id: p1bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and $Log: p1bdespro.asm,v $
...
; Added $Id$. and
; Added $Id: p1bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and Revision 1.1.2.1  2001/01/21 16:57:16  cyp
; Added $Id: p1bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and reorg
; Added $Id: p1bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and
; Added $Id: p1bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and Revision 1.4  1998/12/25 03:23:43  cyp
; Added $Id: p1bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and Bryd now supports upto 4 processors. The third and fourth processor will
; Added $Id: p1bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and use the two (otherwise idle) cores, ie pro on a p5 machine and vice versa.
; Added $Id: p1bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and For non-mt builds the second cores (bbryd_des and bbryd_des_pro) are
; Added $Id: p1bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and aliased to the first two cores (bryd_des and bryd_des_pro) which should
; Added $Id: p1bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and make #ifdef checks around p2des_unit_func_[p5|pro]() obsolete.
; Added $Id: p1bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $. and.
;
...
; TASM Parity? seems buggy, so Parity? not used.
	...
	.data
_id	byte "@(#)$Id: p1bdespro.asm,v 1.2 2002/09/02 00:35:45 andreasb Exp $"
	byte 0
align 4
