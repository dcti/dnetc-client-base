...
/*
 * $Log: gentestsdes.c,v $
 * Revision 1.1.2.1  1998/06/18 05:45:05  remi
 * This is not a C++ source, this is a C source.
 *
...
static char *id="@(#)$Id: gentestsdes.c,v 1.1.2.1 1998/06/18 05:45:05 remi Exp $";
