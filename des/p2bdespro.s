 //
 // $Log: p2bdespro.s,v $
 // Revision 1.1  1998/06/16 21:49:50  silby
 ...
 //
 // Revision 1.7  1998/06/15 23:46:47  daa
 // add a .align 4 after the _Id: to ensure the rest of .data is long aligned
 //
 // Revision 1.6  1998/06/14 11:31:55  remi
 // Hmm, it's "$Id: p2bdespro.s,v 1.1 1998/06/16 21:49:50 silby Exp $", not "$Id".
 // And removed the extra $Log entries... It seems we had a 'commit' war
 // this morning ! :-)
 //
 // Revision 1.5  1998/06/14 11:24:24  remi
 // Added "@(#)$Id".
 //
 // Revision 1.4  1998/06/14 10:40:48  friedbait
 // 'Log' keywords added
 //
 // Revision 1.3  1998/06/14 10:34:09  remi
...
//extern _bryd_continue:near 
//extern _bryd_key_found:near 
 
 .globl _p2bryd_des
 .globl _p2desencrypt
 .globl _p2desdecrypt
 .globl _p2desinit
 .globl _p2key_byte_to_hex
 .globl _p2c_key_byte_to_hex
 
         .data  
      
_id:	        .ascii "@(#)$Id: p2bdespro.s,v 1.1 1998/06/16 21:49:50 silby Exp $"
		.byte 0
		.align 4
 ...
 _p2key_byte_to_hex:        // procedure
         movl $0,add_zero
         jmp key_byte_to_hex_1  
 _p2c_key_byte_to_hex:
         movl $1,add_zero
 key_byte_to_hex_1:
