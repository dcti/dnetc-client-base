 //
 // $Log: p1bdespro.s,v $
 // Revision 1.1  1998/06/16 21:49:48  silby
 ...
 // Hmm, it's "$Id: p1bdespro.s,v 1.1 1998/06/16 21:49:48 silby Exp $", not "$Id".
...
//extern _bryd_key_found:near 
 ...
 .globl _p1desdecrypt
 .globl _p1desinit
 .globl _p1key_byte_to_hex
 .globl _p1c_key_byte_to_hex
 
         .data  
      
_id:	        .ascii "@(#)$Id: p1bdespro.s,v 1.1 1998/06/16 21:49:48 silby Exp $"
		.byte 0
		.align 4
 ...
 _p1key_byte_to_hex:        // procedure
         movl $0,add_zero
         jmp key_byte_to_hex_1  
 _p1c_key_byte_to_hex:
         movl $1,add_zero
 key_byte_to_hex_1:
