 ...
 *
 * $Id: r72stream-vc4.cpp,v 1.6 2009/03/29 20:02:27 andreasb Exp $
*/

#include "r72stream-common.h"
#include "r72stream-vc4_il.cpp"
...
bool init_rc5_72_il4(u32 Device)
{
  ...
  //-------------------------------------------------------------------------
  if (calclCompile(&CContext[Device].obj, CAL_LANGUAGE_IL, il4_src, CContext[Device].attribs.target) != CAL_RESULT_OK)
  {
