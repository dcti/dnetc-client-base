...
u32 rc5_72_ansi_4_unit_func (RC5_72UnitWork *rc5_72unitwork, u32 timeslice)
{
  ...
  while (timeslice--)
  {
    ...
    if (A3 == rc5_72unitwork->cypher.lo)
    {
      ...
      rc5_72unitwork->check.vhi = rc5_72unitwork->L0.vhi;
      rc5_72unitwork->check.hi = rc5_72unitwork->L0.hi;
      rc5_72unitwork->check.lo = rc5_72unitwork->L0.lo + 0x02000000;
    ...
    if (A4 == rc5_72unitwork->cypher.lo)
    {
      ...
      rc5_72unitwork->check.vhi = rc5_72unitwork->L0.vhi;
      rc5_72unitwork->check.hi = rc5_72unitwork->L0.hi;
      rc5_72unitwork->check.lo = rc5_72unitwork->L0.lo + 0x03000000;
    ...
    key.lo = (key.lo + ( 4 << 24));// & 0xFFFFFFFFu;
