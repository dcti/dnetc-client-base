...
#
# $Id: r72-cellv1-ppe.s,v 1.1.2.1 2007/08/02 08:08:37 decio Exp $
#
# $Log: r72-cellv1-ppe.s,v $
# Revision 1.1.2.1  2007/08/02 08:08:37  decio
# Initial Cell/Playstation 3 port.
#
...
#=============================================================================
		...
		.text
		.align	4
		.globl	rc5_72_unit_func_cellv1_ppe	# elf
		.globl	.rc5_72_unit_func_cellv1_ppe	# coff
		.globl	_rc5_72_unit_func_cellv1_ppe	# a.out
...
rc5_72_unit_func_cellv1_ppe:	# elf
.rc5_72_unit_func_cellv1_ppe:	# coff
_rc5_72_unit_func_cellv1_ppe:	# a.out
...
inc_key_mid:
		...
		lis		r0,(P+2*Q)@h		# S[2] = P + 2Q
		lwbrx	r24,r9,r7 			# key.lo (byte reversed)
		ori		r0,r0,(P+2*Q)@l	# S[2] = P + 2Q
