 ...
 *
 * $Id: r72cuda-2pipe.cu,v 1.32 2012/01/13 01:05:36 snikkel Exp $
*/
...
{
  return rc5_72_run_cuda_2(rc5_72unitwork, iterations, rc5_72unitwork->devicenum, 64, default_wait_mode);
}

s32 CDECL rc5_72_unit_func_cuda_2_128(RC5_72UnitWork *rc5_72unitwork, u32 *iterations, void * /*memblk*/)
{
  return rc5_72_run_cuda_2(rc5_72unitwork, iterations, rc5_72unitwork->devicenum, 128, default_wait_mode);
}

s32 CDECL rc5_72_unit_func_cuda_2_256(RC5_72UnitWork *rc5_72unitwork, u32 *iterations, void * /*memblk*/)
{
  return rc5_72_run_cuda_2(rc5_72unitwork, iterations, rc5_72unitwork->devicenum, 256, default_wait_mode);
}
