...
# architectures
#
# $Id: r72-KKS604e.toc.s,v 1.2 2003/09/12 23:08:52 mweiser Exp $
#
...
#============================================================================
		...
		.globl  rc5_72_unit_func_KKS604e	# function pointer toc entry
		.globl  .rc5_72_unit_func_KKS604e	# function label for coff
...
#				void * /*memblk (r5) */)
	...
	.toc
	.csect .rc5_72_unit_func_KKS604e[DS]
rc5_72_unit_func_KKS604e:
	# set the TOC anchor
	.long .rc5_72_unit_func_KKS604e, TOC[tc0], 0

	.csect .text[PR],4	# start text[program code] section
.rc5_72_unit_func_KKS604e:
...
set_counter:
		...
		# load &expanded_key[0] via TOC lookup first because r2 will
		# then be destroyed to hold cypher_lo
		lwz		r10,tc_r72_KKS604e_expanded_key(r2)
		lwz		r2,cypher_lo(r3)
...
#============================================================================
	...
	# has to be global to be able to add it to the toc
	.globl r72_KKS604e_expanded_key

	# make toc entry for expanded key so we can load its address into r10
	.toc
tc_r72_KKS604e_expanded_key:
        .tc r72_KKS604e_expanded_key[tc],r72_KKS604e_expanded_key

	.csect .data[RO],4
r72_KKS604e_expanded_key:			# Static expanded key table S[]
