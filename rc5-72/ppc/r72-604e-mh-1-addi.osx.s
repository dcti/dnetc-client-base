...
;
; $Id: r72-604e-mh-1-addi.osx.s,v 1.1.2.1 2003/04/03 22:24:00 oliver Exp $
;
...
gcc2_compiled.:
	...
	.globl rc5_72_unit_func_mh604e_addi
...
mainloop:
    ...
    stw     S09,mS09(r1)
    stw     S10,mS10(r1)
        addis   S07,r3,ha16(P7Q)   ; Round 1.7
    ...
    add     scr,S13,L2
    add     L0,L0,scr
        addis   S08,S07,ha16(P8Q)    ; Round 1.8
    ...
    add     scr,S15,L1
    add     L2,L2,scr
        addis   S09,S08,ha16(P9Q)  ; Round 1.9
    ...
    add     scr,S17,L0
    add     L1,L1,scr
        addis   S10,S09,ha16(P10Q) ; Round 1.10
    ...
    add     scr,S19,L2
    add     L0,L0,scr
        addis   S11,S10,ha16(P11Q) ; Round 1.11
    ...
    add     scr,S21,L1
    add     L2,L2,scr
        addis   S12,S11,ha16(P12Q) ; Round 1.12
    ...
    add     scr,S23,L0
    add     L1,L1,scr
        addis   S13,S12,ha16(P13Q) ; Round 1.13
    ...
    add     A,A,mem             ; Round 3.1
        addis   S14,S13,ha16(P14Q) ; Round 1.14
    add     A,A,L1
        add     S14,S14,L1n
    rotlwi  A,A,3
        addi    S14,S14,lo16(P14Q)
...
; r29-r31:  L0n-L2n from round 1. Preserve these.
    ...
    add     A,A,L2
    rotlwi  A,A,3
        addis     scrn,S14,ha16(P15Q)  ; Round 1.15
    rotlw   eA,eA,eB
    add     scr,A,L2
    add     eA,eA,A
    add     L0,L0,scr
    ...
    add     scr,A,L0
    rotlw   eB,eB,eA
        addis   scrn,S15,ha16(P16Q)    ; Round 1.16
    add     eB,eB,A
    add     L1,L1,scr

    rotlw   L1,L1,scr
        addi    scrn,scrn,lo16(P16Q)
    ...
    add     scr,A,L1
    rotlw   eA,eA,eB
        addis   scrn,S16,ha16(P17Q)    ; Round 1.17
    add     eA,eA,A
    add     L2,L2,scr

    rotlw   L2,L2,scr
        addi    scrn,scrn,lo16(P17Q)
    ...
    add     scr,A,L2
    rotlw   eB,eB,eA
        addis   scrn,S17,ha16(P18Q)    ; Round 1.18
    add     eB,eB,A
    add     L0,L0,scr

    rotlw   L0,L0,scr
        addi    scrn,scrn,lo16(P18Q)
    ...
    add     scr,A,L0
    rotlw   eA,eA,eB
        addis   scrn,S18,ha16(P19Q)    ; Round 1.19
    add     eA,eA,A
    add     L1,L1,scr

    rotlw   L1,L1,scr
        addi    scrn,scrn,lo16(P19Q)
    ...
    add     scr,A,L1
    rotlw   eB,eB,eA
        addis   scrn,S19,ha16(P20Q)   ; Round 1.20
    add     eB,eB,A
    add     L2,L2,scr

    rotlw   L2,L2,scr
        addi    scrn,scrn,lo16(P20Q)
    ...
    add     scr,A,L2
    rotlw   eA,eA,eB
        addis   scrn,S20,ha16(P21Q)   ; Round 1.21
    add     eA,eA,A
    add     L0,L0,scr

    rotlw   L0,L0,scr
        addi    scrn,scrn,lo16(P21Q)
    ...
    add     scr,A,L0
    rotlw   eB,eB,eA
        addis   scrn,S21,ha16(P22Q)    ; Round 1.22
    add     eB,eB,A
    add     L1,L1,scr

    rotlw   L1,L1,scr
        addi    scrn,scrn,lo16(P22Q)
    ...
    add     scr,A,L1
    rotlw   eA,eA,eB
        addis   scrn,S22,ha16(P23Q)    ; Round 1.23
    add     eA,eA,A
    add     L2,L2,scr

    rotlw   L2,L2,scr
        addi    scrn,scrn,lo16(P23Q)
    ...
    rotlw   eB,eB,eA
        addis   scrn,S23,ha16(P24Q)    ; Round 1.24
    add     eB,eB,A
    add     L0,L0,scr

    rotlw   L0,L0,scr
        addi    scrn,scrn,lo16(P24Q)
    ...
    xor     eA,eA,eB
        ...
        rotlw   L0,L0,scrn
        addis   S25,S24,ha16(P25Q)
        addi    S25,S25,lo16(P25Q)
...
.set    kcsave_regs,208
    ...
    lis     PnQ,hi16(P2Q)   ; Init P+nQ (to P+2Q) and Q
    ori     PnQ,PnQ,lo16(P2Q)
    lis     rQ,hi16(Q)
    ori     rQ,rQ,lo16(Q)
...
check_store:
    ...
    ; Iteration 1
    lis     A,hi16(PR3Q)        ; Init A to P<<3 + P + Q
    ori     A,A,lo16(PR3Q)
