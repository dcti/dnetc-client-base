...
# architectures
#
# $Id: r72-604e-mh-1-addi.toc.s,v 1.1.2.2 2004/05/15 08:31:09 mweiser Exp $
#
# $Log: r72-604e-mh-1-addi.toc.s,v $
...
.globl  rc5_72_unit_func_mh604e_addi    # function pointer toc entry
.globl  .rc5_72_unit_func_mh604e_addi   # function label for coff
...
# Constants
#
# gas doesn't support @ha, @h and @l operators on constants with coff
# so we have to split them into _h and _l versions and have to anticipate
# sign extension by adding 1 to _h to get _ha when _l is larger than 0x8000.
# The _l's have to be sign extended by us so that the assembler doesn't complain
# about value range
.set    P,0xb7e15163
.set    P_h,0xb7e1
.set    P_l,0x5163
...
.set    P3Q_ha,0x9287 + 1
.set    P3Q_l,0xbe8e - 0x8000 - 0x8000
.set    P4Q,0x30bf3847      # P+4Q
.set    P4Q_ha,0x30bf
.set    P4Q_l,0x3847
.set    P5Q,0xCEF6B200
.set    P5Q_ha,0xCEF6 + 1
.set    P5Q_l,0xB200 - 0x8000 - 0x8000
.set    P6Q,0x6D2E2BB9
.set    P6Q_ha,0x6D2E
.set    P6Q_l,0x2BB9
.set    P7Q,0x0B65A572
.set    P7Q_ha,0x0B65 + 1
.set    P7Q_l,0xA572 - 0x8000 - 0x8000
.set    P8Q,0xA99D1F2B
.set    P8Q_ha,0xA99D
.set    P8Q_l,0x1F2B
.set    P9Q,0x47D498E4
.set    P9Q_ha,0x47D4 + 1
.set    P9Q_l,0x98E4 - 0x8000 - 0x8000
.set    P10Q,0xE60C129D
.set    P10Q_ha,0xE60C
.set    P10Q_l,0x129D
.set    P11Q,0x84438C56
.set    P11Q_ha,0x8443 + 1
.set    P11Q_l,0x8C56 - 0x8000 - 0x8000
.set    P12Q,0x227B060F
.set    P12Q_ha,0x227B
.set    P12Q_l,0x060F
.set    P13Q,0xC0B27FC8
...
.set    P13Q_l,0x7FC8
.set    P14Q,0x5EE9F981
.set    P14Q_ha,0x5EE9 + 1
.set    P14Q_l,0xF981 - 0x8000 - 0x8000
.set    P15Q,0xFD21733A
.set    P15Q_ha,0xFD21
.set    P15Q_l,0x733A
.set    P16Q,0x9B58ECF3
.set    P16Q_ha,0x9B58 + 1
.set    P16Q_l,0xECF3 - 0x8000 - 0x8000
.set    P17Q,0x399066AC
.set    P17Q_ha,0x3990
.set    P17Q_l,0x66AC
.set    P18Q,0xD7C7E065
.set    P18Q_ha,0xD7C7 + 1
.set    P18Q_l,0xE065 - 0x8000 - 0x8000
.set    P19Q,0x75FF5A1E
.set    P19Q_ha,0x75FF
.set    P19Q_l,0x5A1E
.set    P20Q,0x1436D3D7
.set    P20Q_ha,0x1436 + 1
.set    P20Q_l,0xD3D7 - 0x8000 - 0x8000
.set    P21Q,0xB26E4D90
.set    P21Q_ha,0xB26E
.set    P21Q_l,0x4D90
.set    P22Q,0x50A5C749
.set    P22Q_ha,0x50A5 + 1
.set    P22Q_l,0xC749 - 0x8000 - 0x8000
.set    P23Q,0xEEDD4102
.set    P23Q_ha,0xEEDD
.set    P23Q_l,0x4102
.set    P24Q,0x8D14BABB
.set    P24Q_ha,0x8D14 + 1
.set    P24Q_l,0xBABB - 0x8000 - 0x8000
.set    P25Q,0x2B4C3474
.set    P25Q_ha,0x2B4C
.set    P25Q_l,0x3474
...
#           (r5 = void * memblk -- unused)
    ...
    .toc
    .csect .rc5_72_unit_func_mh604e_addi[DS]
rc5_72_unit_func_mh604e_addi:
    # set the TOC anchor
    .long .rc5_72_unit_func_mh604e_addi, TOC[tc0], 0

    .csect .text[PR]            # start text[program code] section
    .align 4
.rc5_72_unit_func_mh604e_addi:  # coff
    stwu    r1,-var_size(r1)
...
mainloop:
    ...
    lwz     r5,mS05n(r1)
    add     scr,r4,L2
        addis   r30,r30,P4Q_ha  # Round 1.4
    add     L0,L0,scr
    stw     r3,mS03(r1)
    ...
    rotlwi  r5,r5,3
    lwz     r4,mS06n(r1)
        addi     r3,r30,P4Q_l   # Now use r3 as An
    add     scr,r5,L0
        add     r3,r3,L0n
    add     L1,L1,scr
    ...
    add     scr,S13,L2
    add     L0,L0,scr
        addis   S08,S07,P8Q_ha    # Round 1.8
    ...
    add     scr,S15,L1
    add     L2,L2,scr
        addis   S09,S08,P9Q_ha  # Round 1.9
    ...
    add     scr,S17,L0
    add     L1,L1,scr
        addis   S10,S09,P10Q_ha # Round 1.10
    ...
    add     scr,S19,L2
    add     L0,L0,scr
        addis   S11,S10,P11Q_ha # Round 1.11
    ...
    add     scr,S21,L1
    add     L2,L2,scr
        addis   S12,S11,P12Q_ha # Round 1.12
    ...
    add     scr,S23,L0
    add     L1,L1,scr
        addis   S13,S12,P13Q_ha # Round 1.13
    ...
    add     A,A,mem             # Round 3.1
        addis   S14,S13,P14Q_ha # Round 1.14
    add     A,A,L1
        add     S14,S14,L1n
    rotlwi  A,A,3
        addi    S14,S14,P14Q_l
...
# r29-r31:  L0n-L2n from round 1. Preserve these.
    ...
    add     A,A,L2
    rotlwi  A,A,3
        addis     scrn,S14,P15Q_ha  # Round 1.15
    rotlw   eA,eA,eB
    add     scr,A,L2
    add     eA,eA,A
    add     L0,L0,scr
    ...
    add     scr,A,L0
    rotlw   eB,eB,eA
        addis   scrn,S15,P16Q_ha    # Round 1.16
    add     eB,eB,A
    add     L1,L1,scr

    rotlw   L1,L1,scr
        addi    scrn,scrn,P16Q_l
    ...
    add     scr,A,L1
    rotlw   eA,eA,eB
        addis   scrn,S16,P17Q_ha    # Round 1.17
    add     eA,eA,A
    add     L2,L2,scr

    rotlw   L2,L2,scr
        addi    scrn,scrn,P17Q_l
    ...
    add     scr,A,L2
    rotlw   eB,eB,eA
        addis   scrn,S17,P18Q_ha    # Round 1.18
    add     eB,eB,A
    add     L0,L0,scr

    rotlw   L0,L0,scr
        addi    scrn,scrn,P18Q_l
    ...
    add     scr,A,L0
    rotlw   eA,eA,eB
        addis   scrn,S18,P19Q_ha    # Round 1.19
    add     eA,eA,A
    add     L1,L1,scr

    rotlw   L1,L1,scr
        addi    scrn,scrn,P19Q_l
    ...
    add     scr,A,L1
    rotlw   eB,eB,eA
        addis   scrn,S19,P20Q_ha   # Round 1.20
    add     eB,eB,A
    add     L2,L2,scr

    rotlw   L2,L2,scr
        addi    scrn,scrn,P20Q_l
    ...
    add     scr,A,L2
    rotlw   eA,eA,eB
        addis   scrn,S20,P21Q_ha   # Round 1.21
    add     eA,eA,A
    add     L0,L0,scr

    rotlw   L0,L0,scr
        addi    scrn,scrn,P21Q_l
    ...
    add     scr,A,L0
    rotlw   eB,eB,eA
        addis   scrn,S21,P22Q_ha    # Round 1.22
    add     eB,eB,A
    add     L1,L1,scr

    rotlw   L1,L1,scr
        addi    scrn,scrn,P22Q_l
    ...
    add     scr,A,L1
    rotlw   eA,eA,eB
        addis   scrn,S22,P23Q_ha    # Round 1.23
    add     eA,eA,A
    add     L2,L2,scr

    rotlw   L2,L2,scr
        addi    scrn,scrn,P23Q_l
    ...
    rotlw   eB,eB,eA
        addis   scrn,S23,P24Q_ha    # Round 1.24
    add     eB,eB,A
    add     L0,L0,scr

    rotlw   L0,L0,scr
        addi    scrn,scrn,P24Q_l
...
ctrzero:
    ...
    addis   r30,r30,P2Q_ha  # r30=S1XP2Q
    stw     r30,S1XP2Q(r1)
...
l1calc:
    ...
    addis   r30,r30,P3Q_ha  # r30=S2XP3Q
    stw     r30,S2XP3Q(r1)
...
.set    kcsave_regs,208
    ...
    lis     PnQ,P2Q_h   # Init P+nQ (to P+2Q) and Q
    ori     PnQ,PnQ,P2Q_l
    lis     rQ,Q_h
    ori     rQ,rQ,Q_l
...
check_store:
    ...
    # Iteration 1
    lis     A,PR3Q_h        # Init A to P<<3 + P + Q
    ori     A,A,PR3Q_l
